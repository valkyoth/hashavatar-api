...
first_target="${HASHAVATAR_WEBSITE_REPRO_TARGET_A:-target/reproducible-a}"
second_target="${HASHAVATAR_WEBSITE_REPRO_TARGET_B:-target/reproducible-b}"
...
first_binary="$first_target/release/hashavatar-website"
second_binary="$second_target/release/hashavatar-website"
