# hashavatar-website 0.1.0 Release Notes

Status: released

## Summary

`0.1.0` established the first public hashavatar demo website.

These notes are reconstructed from the tag and commit history.

## Added

- Added the initial Rust website and avatar endpoints around the `hashavatar` crate.
