...
The service validates its own public size range before calling the renderer.
The renderer also validates dimensions, identity length, and namespace length.
